        ...
        <div class="text-center max-w-5xl mx-auto">
            <div class="animate-fade-in">
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight mb-8">
                    <span class="block text-[#E0E0E0] mb-2" style="font-family: 'Cinzel', serif;">Master the Elements</span>
                    <span class="block gradient-text mt-2" style="font-family: 'Sloop Script Bold Two', cursive; font-size: 1.2em;">Outerwear Collection</span>
                </h1>
            </div>
            
            <div class="animate-fade-in-delay">
                <p class="text-lg md:text-2xl text-[#E0E0E0]/90 mb-12 max-w-3xl mx-auto leading-relaxed">
                    Jelajahi koleksi jaket dan outerwear premium yang memberikan perlindungan sempurna dengan gaya yang tak tertandingi untuk setiap kondisi cuaca.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center animate-slide-left">
                <button onclick="scrollToProducts()" class="group bg-[#A38560] hover:bg-[#8B7355] text-white font-bold py-5 px-10 rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover-glow relative overflow-hidden">
                    <span class="relative z-10">Shop Outerwear Collection</span>
...
<section id="products-section" class="py-12">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-[#E0E0E0] mb-4">Outerwear Collection</h2>
                            ...
                            <div class="p-6 relative z-10">
                                ...
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <span class="text-gray-500 text-xs font-medium">
                                        {{ $product->category->name ?? 'Outerwear' }}
                                    </span>
                                </div>
                            </div>
                        </a>
        ...
        @else
            ...
            <div class="text-center py-16">
                <div class="max-w-md mx-auto">
                    ...
                    <h3 class="text-2xl font-bold text-[#E0E0E0] mb-4">No Outerwear Available</h3>
                    <p class="text-gray-400 mb-8">
                        We're currently updating our outerwear collection. Check back soon for new arrivals!
                    </p>
