...
@section('content')
<div class="min-h-screen bg-[#16302B] p-4 sm:p-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            <div class="flex items-center justify-center">
                @if($product->image_path)
                    <img src="{{ asset('storage/'.$product->image_path) }}" class="w-100 h-96 object-cover rounded-2xl" alt="{{ $product->name }}">
                @endif
            </div>
        ...
        <!-- Size Selection -->
        <div class="space-y-3">
            <label class="text-sm font-bold text-white">Select Size <span class="text-red-600">*</span></label>
            <div class="flex gap-3">
                <button class="px-4 py-2 border border-[#390517] text-white rounded-lg hover:bg-[#390517] hover:text-white transition-colors font-bold bg-transparent" data-size="S">S</button>
                <button class="px-4 py-2 border border-[#390517] text-white rounded-lg hover:bg-[#390517] hover:text-white transition-colors font-bold bg-transparent" data-size="M">M</button>
                <button class="px-4 py-2 border border-[#390517] text-white rounded-lg hover:bg-[#390517] hover:text-white transition-colors font-bold bg-transparent" data-size="L">L</button>
                <button class="px-4 py-2 border border-[#390517] text-white rounded-lg hover:bg-[#390517] hover:text-white transition-colors font-bold bg-transparent" data-size="XL">XL</button>
                <button class="px-4 py-2 border border-[#390517] text-white rounded-lg hover:bg-[#390517] hover:text-white transition-colors font-bold bg-transparent" data-size="XXL">XXL</button>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('cart.add', $product) }}" class="space-y-4" onsubmit="return validateForm()">
            ...
            <div id="error-message" class="hidden bg-red-600 text-white px-4 py-2 rounded-lg text-sm">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center border border-[#390517] rounded-lg overflow-hidden">
                        <button type="button" class="px-4 py-2 bg-transparent text-white text-xl font-bold hover:bg-white hover:text-[#16302B] transition-colors" onclick="decreaseQty()">-</button>
                        <input id="qty" name="qty" type="text" value="1" class="w-16 py-2 text-center bg-transparent text-white text-xl font-bold border-0 focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" readonly>
                        <button type="button" class="px-4 py-2 bg-transparent text-white text-xl font-bold hover:bg-white hover:text-[#16302B] transition-colors" onclick="increaseQty()">+</button>
                    </div>
                    
                    <button type="submit" class="bg-[#A38560] text-white py-3 px-20 rounded-full font-bold text-lg hover:bg-[#8a6b47] transition-colors">
                        + Add to Cart
                    </button>
                </div>
        </form>
        ...
        <div class="mb-8">
            <div id="shipping-box" class="bg-[#390517] rounded-2xl p-6 lg:p-8 slide-box collapsed">
                <button type="button" class="flex items-center justify-between w-full text-left" onclick="toggleSection('shipping'); return false;">
                    <h3 class="text-xl font-semibold text-white">Shipping</h3>
                    ...
                    <div class="text-white space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-white opacity-70">7 - 14 Working Days</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-white opacity-70">16 - 23 October 2024</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-white opacity-70">Include Package</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="text-white">
                <h2 class="text-2xl font-bold text-white mb-6">Rating & Reviews</h2>
                <div class="flex items-center gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-lg text-white opacity-70">(50 New Reviews)</div>
                    </div>
            ...
            <div class="relative">
                <div class="overflow-hidden rounded-2xl">
                    <div id="review-slider" class="flex transition-transform duration-300 ease-in-out">
                        ...
                        <div class="w-full flex-shrink-0">
                            <div class="bg-[#390517] rounded-2xl p-6">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-white opacity-70">13 October 2025</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-white leading-relaxed">
                                    "Produk berkualitas tinggi dengan desain yang sangat bagus. Bahannya nyaman dipakai dan sesuai dengan ekspektasi. Highly recommended!"
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-white opacity-70">10 October 2025</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-white leading-relaxed">
                                    "Kualitas bagus dan pengiriman cepat. Ukurannya pas sesuai size chart. Recommended untuk yang suka fashion trendy!"
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-white opacity-70">8 October 2025</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-white leading-relaxed">
                                    "Sangat merekomendasikan! Modelnya trendy dan cocok untuk berbagai acara. Material premium dengan harga yang worth it."
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="w-full flex-shrink-0">
                            <div class="bg-[#390517] rounded-2xl p-6">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <div class="font-semibold text-white">Maya Putri</div>
                                        <div class="flex items-center gap-2">
                                            <div class="flex">
                                                <span class="text-yellow-400">★★★★★</span>
                                            </div>
                                            <span class="text-sm text-white opacity-70">5 October 2025</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-white leading-relaxed">
                                    "Love it! Bahan tidak panas dan nyaman dipakai seharian. Packaging juga rapi. Pasti akan beli lagi di sini."
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Navigation Arrows -->
                <button id="prev-review" class="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-colors backdrop-blur-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                    </svg>
                </button>
                
                <button id="next-review" class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-colors backdrop-blur-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
